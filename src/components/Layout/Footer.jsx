...
import { IconEnvelopeFillDuo18 as Mail, IconSparkleFillDuo18 as Sparkle } from 'nucleo-ui-fill-duo-18'
      ...
      <div className="py-12 px-6">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col items-center sm:items-end gap-2 text-sm text-gray-500">
            ...
            <div>
              <Link to="/changelog" className="inline-flex items-center gap-1.5 text-gray-500 hover:text-gray-900 transition-colors"><Sparkle className="w-4 h-4" />What's New</Link>
            </div>
            <p>
              Data from{' '}
