        ...
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col items-center sm:items-end gap-2 text-sm text-gray-500">
            <div className="flex gap-4">
              <a href="mailto:hello@mindthegap.fyi" className="inline-flex items-center gap-1.5 text-gray-500 hover:text-gray-900 transition-colors"><IconEnvelopeOutline24 className="w-4 h-4" />Email</a>
